  ...
  return (
          ...
          <div className="card-body p-4">
            ...
            <ul className="timeline-widget mb-0 position-relative mb-n5">
              ...
              <li className="timeline-item d-flex position-relative overflow-hidden">
                ...
                <div className="timeline-desc fs-3 text-dark mt-n1 fw-semibold">New sale recorded <Link
                   className="text-primary d-block fw-normal">#ML-3467</Link>
                </div>
              </li>
              <li className="timeline-item d-flex position-relative overflow-hidden">
    ...
    <div className="row">
      <div className="col-sm-6 col-xl-3">
        <div className="card overflow-hidden rounded-2">
          <div className="position-relative">
            <Link ><img src="../assets/images/products/s4.jpg" className="card-img-top rounded-0" alt="..."/></Link>
            <Link  className="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i className="ti ti-basket fs-4"></i></Link>                      </div>
          <div className="card-body pt-3 p-4">
            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              <ul className="list-unstyled d-flex align-items-center mb-0">
                <li><Link className="me-1" ><i className="ti ti-star text-warning"></i></Link></li>
                <li><Link className="me-1" ><i className="ti ti-star text-warning"></i></Link></li>
                <li><Link className="me-1" ><i className="ti ti-star text-warning"></i></Link></li>
                <li><Link className="me-1" ><i className="ti ti-star text-warning"></i></Link></li>
                <li><Link className="" ><i className="ti ti-star text-warning"></i></Link></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="col-sm-6 col-xl-3">
        <div className="card overflow-hidden rounded-2">
          <div className="position-relative">
            <Link ><img src="../assets/images/products/s5.jpg" className="card-img-top rounded-0" alt="..."/></Link>
            <Link  className="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i className="ti ti-basket fs-4"></i></Link>                      </div>
          <div className="card-body pt-3 p-4">
      ...
      <div className="col-sm-6 col-xl-3">
        <div className="card overflow-hidden rounded-2">
          <div className="position-relative">
            <Link ><img src="../assets/images/products/s7.jpg" className="card-img-top rounded-0" alt="..."/></Link>
            <Link  className="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i className="ti ti-basket fs-4"></i></Link>                      </div>
          <div className="card-body pt-3 p-4">
      ...
      <div className="col-sm-6 col-xl-3">
        <div className="card overflow-hidden rounded-2">
          <div className="position-relative">
            <Link ><img src="../assets/images/products/s11.jpg" className="card-img-top rounded-0" alt="..."/></Link>
            <Link  className="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i className="ti ti-basket fs-4"></i></Link>                      </div>
          <div className="card-body pt-3 p-4">
